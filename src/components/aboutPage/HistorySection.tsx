...
const HistorySection = () => {
    return (
        <section id='about' className='px-primary mt-[107px]'>
            ...
            <div className='flex justify-center flex-col gap-5 md:text-lg w-full'>
                <p>
                ...
                <p>
                    Ao longo de mais de duas décadas, a UMADMEGO tem sido um canal de bênçãos para a juventude cristã, promovendo transformação espiritual e crescimento pessoal.
                    <br/>Nosso Congresso Geral é o ponto alto do ano, reunindo milhares de jovens em um evento repleto de louvor, ensino e experiências impactantes.
                </p>
                <p>
