  ...
  return (
      <section id='about' className='px-primary mt-[107px]'>
        ...
        <div className='flex flex-col gap-5 md:text-lg w-full'>
          ...
          <p>
            Prepare-se para fazer parte do nosso próximo Congresso Geral e experimente uma jornada espiritual inesquecível. Deus tem grandes coisas reservadas para você!
          </p>
            <br/>
        </div>
      </section>
